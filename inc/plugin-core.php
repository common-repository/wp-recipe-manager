...
if ( ! class_exists( 'WPRM_Core' ) ) {
	class WPRM_Core {
		...
		public function admin_enqueue_assets() {
			wp_enqueue_style( 'tmu-admin-style', WPRM_URL . 'assets/core/css/admin.css', array() );
		}
		...
		public function rss_news_widget() {
			...
			echo '<div class="tips-news-footer">
					<a href="https://tomiup.com/?utm_source=wprm" target="_blank">Tomiup <span class="screen-reader-text">(opens in a new window)</span><span aria-hidden="true" class="dashicons dashicons-external"></span></a>
				</div>';
		}
